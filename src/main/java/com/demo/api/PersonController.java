...
public class PersonController {
    @GetMapping()
    public String home() {
                return "Welcome this is home page, Please:"+"<br/><br/><br/>"+"- Add <B>/spring</B> to see definition of Spring. <br/><br/>- Add <B>/hello/{yourname}</B> in the path to view your message.";
    }
